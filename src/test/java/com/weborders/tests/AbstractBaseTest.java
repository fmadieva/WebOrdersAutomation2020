...
public class AbstractBaseTest {
    ...
    public void teardown(ITestResult testResult){
        if(testResult.getStatus() == ITestResult.FAILURE){
            String screenshotLocation = BrowserUtilities.getScreenshot(testResult.getName());  // path to screenshot
            try{
        ...
        Driver.closeDriver(); // or driver.quit()
    }

}

// to determine test status - ITestResult
